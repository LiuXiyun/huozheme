...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    await pushEvent({
      ...
      typeCode: sanitize(body.typeCode, 20),
      entryTypeCode: sanitize(body.entryTypeCode, 20),
      compatibilityScore: Number.isFinite(Number(body.compatibilityScore)) ? Number(body.compatibilityScore) : undefined,
