...
一个可部署到 Vercel / ECS 的 H5：用户完成 5 题测试后，生成 128 型精神存活人格代码、关系图谱预览、分享文案和可保存海报。
...
- 7 维 128 型精神存活人格代码，组合式中文人格名和今日变体。
- 精神存活指数、同城稀有度、撞型样本、今日故障点和复活方式。
- 分享图工厂：报告卡、朋友圈、小红书三种模板，海报带人格代码、回流链接和二维码。
- 分享链接携带人格代码，好友回流后可生成匹配度与关系卡。
- 毒舌强度切换和分享文案刷新。
- 9.9 完整关系图谱内测锁价入口。
